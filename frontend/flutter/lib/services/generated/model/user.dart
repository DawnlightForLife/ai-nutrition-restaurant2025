...
class User {
  ...
  int get hashCode =>
    ...
    (currentRole == null ? 0 : currentRole!.hashCode);

  @override
  String toString() => 'User[id=$id, nickname=$nickname, currentRole=$currentRole]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.currentRole != null) {
      json[r'currentRole'] = this.currentRole;
    } else {
      json[r'currentRole'] = null;
    }
    return json;
  }
  ...
  static User? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return User(
        ...
        currentRole: mapValueOfType<String>(json, r'currentRole'),
      );
    }
    return null;
  }

...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    TestErrorRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const TestErrorPage(),
      );
    },
...
/// generated route for
/// [TestErrorPage]
class TestErrorRoute extends PageRouteInfo<void> {
  const TestErrorRoute({List<PageRouteInfo>? children})
      : super(
          TestErrorRoute.name,
          initialChildren: children,
        );

  static const String name = 'TestErrorRoute';
...
/// generated route for
/// [TestHomePage]
class TestHomeRoute extends PageRouteInfo<void> {
  const TestHomeRoute({List<PageRouteInfo>? children})
      : super(
          TestHomeRoute.name,
          initialChildren: children,
        );

...
/// @nodoc
mixin _$OrderState {
  List<Uorder> get orders => throw _privateConstructorUsedError;
...
abstract class $OrderStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Uorder> orders, bool isLoading, String? errorMessage});
}
...
class _$OrderStateImpl implements _OrderState {
  const _$OrderStateImpl(
      {final List<Uorder> orders = const [],
  ...
  @override
  String toString() {
    return 'OrderState(orders: $orders, isLoading: $isLoading, errorMessage: $errorMessage)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_orders), isLoading, errorMessage);

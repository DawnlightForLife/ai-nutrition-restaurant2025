...
part of 'ai_recommendation_api.dart';
...
class _AIRecommendationApi implements AIRecommendationApi {
  _AIRecommendationApi(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  });
  ...
  Future<HttpResponse<Map<String, dynamic>>> generateRecommendation(
    ...
    final _options = _setStreamType<HttpResponse<Map<String, dynamic>>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/nutrition/profiles/${profileId}/recommendations',
  ...
  Future<HttpResponse<Map<String, dynamic>>> submitFeedback(
    ...
    final _options = _setStreamType<HttpResponse<Map<String, dynamic>>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/nutrition/recommendations/${recommendationId}/feedback',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<HttpResponse<Map<String, dynamic>>> saveAdjustments(
    ...
    final _options = _setStreamType<HttpResponse<Map<String, dynamic>>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/nutrition/recommendations/${recommendationId}/adjustments',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(

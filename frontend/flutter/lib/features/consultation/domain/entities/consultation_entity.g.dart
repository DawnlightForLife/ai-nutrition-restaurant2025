...
_$ConsultationEntityImpl _$$ConsultationEntityImplFromJson(
        Map<String, dynamic> json) =>
    _$ConsultationEntityImpl(
...
Map<String, dynamic> _$$ConsultationEntityImplToJson(
        _$ConsultationEntityImpl instance) =>
    <String, dynamic>{
      '_id': instance.id,

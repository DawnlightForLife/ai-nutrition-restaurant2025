...
class _$ChatMessageEntityImpl implements _ChatMessageEntity {
  ...
  @override
  String toString() {
    return 'ChatMessageEntity(id: $id, consultationId: $consultationId, senderId: $senderId, senderName: $senderName, senderType: $senderType, messageType: $messageType, content: $content, attachments: $attachments, isRead: $isRead, readAt: $readAt, isEdited: $isEdited, editedAt: $editedAt, isDeleted: $isDeleted, deletedAt: $deletedAt, replyToMessageId: $replyToMessageId, metadata: $metadata, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _ChatMessageEntity implements ChatMessageEntity {
  const factory _ChatMessageEntity(
      ...
      final DateTime? updatedAt}) = _$ChatMessageEntityImpl;
...
class _$MessageAttachmentImpl implements _MessageAttachment {
  ...
  @override
  String toString() {
    return 'MessageAttachment(id: $id, url: $url, type: $type, fileName: $fileName, fileSize: $fileSize, mimeType: $mimeType, metadata: $metadata)';
  }

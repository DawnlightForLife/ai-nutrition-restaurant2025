...
> 说明：本文档提供智能营养餐厅App常用代码模板，整体架构采用模块化结构，代码文件位于 `lib/modules/模块名/{models,providers,screens,services,widgets}` 子目录中。  
> 模板中示例路径如 `../../../modules/example/...` 为示意路径，实际开发时请替换为对应的真实模块名。

本文档便于团队快速创建符合模块化架构规范的代码文件。
...
```dart
import '../../../modules/example/models/model_name.dart';
import '../../../modules/example/models/common/api_response.dart';
...
import '../../../modules/example/models/model_name.dart';
import '../../../modules/example/models/common/api_response.dart';
import '../../../modules/example/domain/abstractions/services/i_api_service.dart';
import '../../../modules/example/domain/abstractions/services/i_module_service.dart';
...
import '../../../modules/example/models/model_name.dart';
import '../../../modules/example/domain/abstractions/services/i_module_service.dart';
import '../../../modules/example/domain/abstractions/repositories/i_module_repository.dart';
...
import '../../../modules/example/models/model_name.dart';
import '../../../modules/example/domain/abstractions/repositories/i_module_repository.dart';
import '../../../modules/example/modules/example/core/result.dart';
...
import '../../../modules/example/models/model_name.dart';
import '../../../modules/example/modules/example/app_use_cases.dart';
import '../../../modules/example/modules/example/do_something_use_case.dart';
import '../../../modules/example/modules/example/core/result.dart';
...
import 'package:your_app/modules/example/domain/abstractions/repositories/i_module_repository.dart';
import 'package:your_app/modules/example/models/model_name.dart';
import 'package:your_app/modules/example/modules/example/do_something_use_case.dart';
...
import 'package:your_app/modules/example/modules/example/app_use_cases.dart';
import 'package:your_app/modules/example/modules/example/do_something_use_case.dart';
import 'package:your_app/modules/example/modules/example/get_data_use_case.dart';
import 'package:your_app/modules/example/modules/example/core/result.dart';
import 'package:your_app/modules/example/models/model_name.dart';
import 'package:your_app/modules/example/providers/module/module_provider.dart';
...
这些模板提供了创建符合模块化架构规范的各类组件的标准方式。在实际开发中，可以根据具体需求进行适当调整，但应保持整体架构风格的一致性。